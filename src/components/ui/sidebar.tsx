...
>(({ className, children, isCollapsed, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        'flex flex-col h-full bg-sidebar text-sidebar-foreground rounded-lg overflow-hidden transition-all duration-300 ease-in-out',
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        'flex min-h-0 flex-1 flex-col gap-2 overflow-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]',
        className
      )}
      {...props}
    />
