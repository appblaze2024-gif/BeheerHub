        ...
        <div className="flex items-center gap-4">
          {activeModule && (
            <Button 
              variant="ghost" 
              size="icon" 
              className="h-10 w-10 rounded-full bg-white shadow-sm border border-slate-100 text-[#4a5ab5]"
          ...
          <div>
            <h1 className="text-2xl font-black uppercase tracking-tight text-[#4a5ab5]">
            ...
            {mainNavItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute right-4 bottom-4 opacity-[0.05] group-hover:opacity-20 group-hover:text-sky-400 transition-all duration-700 pointer-events-none transform group-hover:scale-110">
