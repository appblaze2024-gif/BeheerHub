...
export default function ApiIntegrationsPage() {
  ...
  if (isLoading) return <LoadingScreen message="Koppelingen laden..." />;

  return (
    <div className="flex flex-col h-full bg-slate-50 overflow-hidden">
      <PageHeader title="API Koppelingen" description="Verstuur BeheerHub gegevens naar externe systemen via webhooks.">
        <Button onClick={() => { setSelectedId(null); setIsDialogOpen(true); }} className="font-black h-10 uppercase rounded-none shadow-xl shadow-primary/20">
            ...
            <Card className="lg:col-span-4 flex flex-col rounded-none border-none shadow-xl bg-white overflow-hidden">
                <CardHeader className="p-4 border-b bg-slate-50/50 space-y-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400">Uitgaande Webhooks</h3>
                    </div>
                ...
                <ScrollArea className="flex-1">
                    ...
                    {filteredIntegrations.length === 0 && (
                        <div className="py-12 text-center text-slate-300">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-widest">Geen koppelingen</p>
                        </div>
                    )}
                    </div>
                </ScrollArea>
                ...
                {selectedIntegration ? (
                    ...
                    <ScrollArea className="flex-1">
                        ...
                        <div className="space-y-4">
                            ...
                            {Object.keys(selectedIntegration.mapping).length === 0 && (
                                <p className="text-xs font-bold text-slate-400 uppercase italic p-4 text-center border-2 border-dashed border-slate-100">Geen velden gemapped</p>
                            )}
                            </div>
                        </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-12 text-center text-slate-300">
                        ...
                        <p className="text-xs font-bold text-slate-400 uppercase mt-2 max-w-xs leading-relaxed">Kies een koppeling uit de lijst om details te bekijken of een handmatige synchronisatie te starten.</p>
                    </div>
                )}
            </Card>
        </div>
